...
function widget($args, $instance) {
	...
	if(!$instance["future"])
		...
		$cat_posts = new WP_Query("showposts=" . $instance["num"] . "&cat=" . $instance["cat"]."&post_status=future&order=ASC");
	...
	?>
		<li class="cat-post-item">
			<a class="post-title" href="<?php the_permalink(); ?>" rel="bookmark" title="<?php the_title_attribute(); ?>"><?php if($instance["future"]) the_date("d.m: "); ?><?php the_title(); ?></a>
...
?>
		...
		<p>
			<label for="<?php echo $this->get_field_id("future"); ?>">
				<input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id("future"); ?>" name="<?php echo $this->get_field_name("future"); ?>"<?php checked( (bool) $instance["future"], true ); ?> />
				<?php _e( 'Show future posts' ); ?>
			</label>
		</p>
